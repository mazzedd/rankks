...
import F1MatchVideos from './pages/F1MatchVideos'
import F1IconicMoments from './pages/F1IconicMoments'
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        <Route path="f1-match-videos" element={<F1MatchVideos />} />
        <Route path="f1-iconic-moments" element={<F1IconicMoments />} />
