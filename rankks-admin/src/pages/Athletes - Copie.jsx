...
function AthleteRow({ athlete, sport, onSaved }) {
  ...
  const openEdit = () => {
    setForm({
      ...
      // Drivers only — real FK now (was a fuzzy free-text name before,
      // which silently failed to save whenever it didn't match a
      // countries.name/iso2 row exactly). athlete.country_id is already
      // returned by the backend's driver query (LEFT JOIN countries).
          ...
          <div className={styles.grid}>
            ...
            <div className={`${styles.field} ${styles.fieldWide}`}>
              ...
              <input
                ...
                placeholder={isDriver ? 'media/athletes/motor-racing/slug.png' : 'media/athletes/tennis/male/portrait/slug.png'}
              />
            </div>
