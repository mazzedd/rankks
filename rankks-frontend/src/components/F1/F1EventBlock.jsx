...
import { calcAge, fmtWeekendRange } from '../../utils/calcAge'
      ...
      <div className={styles.banner}>
        <div className={styles.inner}>
          ...
          <div className={styles.portraitWrap}>
            <AthleteAvatar src={resolveImg(champion?.logo_url)} name={champion?.canonical_name} sport="f1" gender="M" className={styles.clubLogo} />
          </div>
        </div>
...
export function F1GPBlock({ gp, sessions, year, primaryColor, secondaryColor, logoUrl }) {
  ...
  const gpStatus = getGpStatus(rawSessionDate)
      ...
      <div className={styles.banner}>
        <div className={styles.inner}>
          ...
          {/* GENDER — hardcoded 'M' for now: F1 has no gender data model
              ...
              in GENDERED_SPORTS. */}
          <div className={styles.portraitWrap}>
            <AthleteAvatar src={resolveImg(raceWinner?.driver_image)} name={raceWinner?.driver_name} sport="f1" gender="M" className={styles.clubLogo} />
          </div>
        </div>
