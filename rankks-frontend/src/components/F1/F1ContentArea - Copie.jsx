...
const STANDINGS_LINE_B = [
  ...
  { tab_key: 'f1-iconic',      tab_name: 'Iconic' },
]
...
export default function F1ContentArea() {
  ...
  const isStandings  = !activeGPSlug
  ...
  // Line A — Final Standings + GP list
  const lineATabs = [
  ...
  return (
    <div className={styles.area}>
      ...
      <F1LineB
        tabs={isStandings ? STANDINGS_LINE_B : gpLineBTabs}
        activeKey={isStandings ? standingsSubTab : activeSessionId}
        onTabClick={handleLineBClick}
        keyField={isStandings ? 'tab_key' : 'id'}
      />
