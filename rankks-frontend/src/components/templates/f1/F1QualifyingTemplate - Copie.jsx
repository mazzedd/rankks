      ...
      <div className={styles.tableScroll}>
        ...
        <tbody>
          {results.map((r, i) => {
            ...
            const age = calcAge(r.birth_date, eventDate)
            return (
              <tr key={r.driver_id} className="table-row" style={{ animationDelay: `${i * 0.03}s` }}>
                ...
                <td>
                  <div className="entity-cell">
                    {img
                      ? <img src={img} alt={r.driver_name} className="avatar" onError={e => { e.target.style.display = 'none' }} />
                      : <div className="avatar-placeholder">{(r.driver_name || '?').charAt(0)}</div>
                    }
