...
export default function StandingsTemplate({ seasonId, tabKey, tabName, columnConfig, competitionName = '', yearConvention = 'end' }) {
  ...
  // Admin-configured title (tab_titles table) takes priority; falls back
  // to "Standings" if nothing's configured for this competition/tab/year.
  ...
  const pageTitle = data.tab?.page_title || 'Standings'
