// =============================================================
// RANKKS — Belgian Pro League Data Ingestion
// Run: node ingest-belgian-pro-league.js [command] [season]
// Commands: standings, players, fixtures, topscorers, all
// Example: node ingest-belgian-pro-league.js all 2026
// =============================================================
...
const CONFIG = {
  ...
  leagueId:  144,     // Jupiler Pro League (Belgium) — verified via /leagues?country=Belgium
  leagueSlug: 'belgian-pro-league-belgium',
  // Mohamed 2026-08-27: scoped to the current season only, same as
  // Ligue 2/Russian Premier League's onboarding, not a full historical
  // backfill. API-Sports has coverage back to 2010 if ever requested.
  seasons:   [2026],
};
...
async function main() {
  ...
  console.log(`\n🚀 RANKKS Ingestion — Belgian Pro League`);
