// =============================================================
// RANKKS — Turkish Süper Lig Data Ingestion
// Run: node ingest-super-lig.js [command] [season]
// Commands: standings, players, fixtures, topscorers, all
// Example: node ingest-super-lig.js all 2026
// =============================================================
...
const CONFIG = {
  ...
  leagueId:  203,     // Süper Lig (Turkey) — verified via /leagues?country=Turkey
  leagueSlug: 'super-lig-turkey',
  ...
  // API-Sports has coverage back to 2011 if ever requested.
  seasons:   [2026],
};
