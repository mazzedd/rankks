// =============================================================
// RANKKS — Eredivisie (Netherlands) Data Ingestion
// Run: node ingest-eredivisie.js [command] [season]
// Commands: standings, players, fixtures, topscorers, all
// Example: node ingest-eredivisie.js all 2026
// =============================================================
...
const CONFIG = {
  ...
  leagueId:  88,      // Eredivisie (Netherlands) — verified via /leagues?search=Eredivisie
  leagueSlug: 'eredivisie-netherlands',
