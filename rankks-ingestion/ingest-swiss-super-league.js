// =============================================================
// RANKKS — Swiss Super League Data Ingestion
// Run: node ingest-swiss-super-league.js [command] [season]
// Commands: standings, players, fixtures, topscorers, all
// Example: node ingest-swiss-super-league.js all 2026
// =============================================================
...
const CONFIG = {
  ...
  leagueId:  207,     // Super League (Switzerland) — verified via /leagues?country=Switzerland
  leagueSlug: 'swiss-super-league-switzerland',
  // Mohamed 2026-08-27: scoped to the current season only, same as the
  // other recently-onboarded leagues — not a full historical backfill.
  seasons:   [2026],
};
...
async function main() {
  ...
  console.log(`\n🚀 RANKKS Ingestion — Swiss Super League`);
